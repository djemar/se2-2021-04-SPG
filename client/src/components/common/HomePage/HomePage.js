...
export const HomePage = ({ ...props }) => {
  return (
    <div className="flex flex-column justify-start m-0 p-0">
      {/* HOME PAGE */}

      {/* Need to remove navbar padding just for this page or ask the picture to overlap on it */}
      <Container className="m-0 p-0 text-center" fluid>
